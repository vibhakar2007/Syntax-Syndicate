...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className={`fixed inset-0 z-50 bg-black/80 backdrop-blur-md text-white flex flex-col h-screen transition-all duration-300 ${
        scroll ? "backdrop-blur-3xl bg-black/80" : "bg-transparent"
          ...
          <div className="flex-1 flex flex-col justify-center items-center gap-6 text-xl font-semibold">
            <Link href="/#work" onClick={() => setIsOpen(false)} className="hover:scale-110 transition-transform duration-200">
              Work
            </Link>
