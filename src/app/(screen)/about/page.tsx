      ...
      <div className="flex-1 w-full flex flex-col md:flex-row items-center justify-center gap-4 lg:gap-6">
        ...
        <div className="md:w-1/2 lg:w-[55%] xl:w-1/2 text-center md:text-left">
          <p className="text-sm md:text-base lg:text-lg xl:text-xl leading-snug md:leading-normal lg:leading-relaxed">
            ...
            pretty — they sell, they scale, and they dominate. In a crowded digital
            world, average doesn&apos;t cut it. You need a site that turns heads,
            drives traffic, and makes your competition rethink everything. Whether
            you&apos;re starting from scratch or leveling up an existing brand, we
            bring unmatched skill, creativity, and strategy to the table — so you
